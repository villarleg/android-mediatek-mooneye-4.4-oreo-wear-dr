...
EXTERN int __ambient_mode;
EXTERN int spm_dvfs_ctrl_volt(unsigned int value);
#define mt_cpufreq_get_ambient_mode()	__ambient_mode
#define mt_cpufreq_set_ambient_mode(x)	__ambient_mode = x
